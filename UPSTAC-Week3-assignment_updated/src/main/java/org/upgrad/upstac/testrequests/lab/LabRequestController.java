...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        //finding the logged in user and get all the unassigned
        // tests so that tester can assign some tests for himself
        User current_user = userLoggedInService.getLoggedInUser();
        return testRequestQueryService.findByTester(current_user);
